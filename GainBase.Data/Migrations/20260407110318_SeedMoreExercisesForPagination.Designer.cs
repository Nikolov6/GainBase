...
namespace GainBase.Data.Migrations
{
    ...
    [Migration("20260407110318_SeedMoreExercisesForPagination")]
    partial class SeedMoreExercisesForPagination
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GainBase.Data.Models.Exercise", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("7e8d2d4a-1d0d-4b17-9f5d-0e7c9d7b1001"),
                        ...
                        new
                        {
                            Id = new Guid("7e8d2d4a-1d0d-4b17-9f5d-0e7c9d7b1002"),
                            CreatedAt = new DateTime(2025, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc),
                            CreatorId = "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
                        ...
                        new
                        {
                            Id = new Guid("7e8d2d4a-1d0d-4b17-9f5d-0e7c9d7b1003"),
                            CreatedAt = new DateTime(2025, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc),
                            CreatorId = "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
                        ...
                        new
                        {
                            Id = new Guid("7e8d2d4a-1d0d-4b17-9f5d-0e7c9d7b1004"),
                            CreatedAt = new DateTime(2025, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc),
                            CreatorId = "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
                        ...
                        new
                        {
                            Id = new Guid("7e8d2d4a-1d0d-4b17-9f5d-0e7c9d7b1005"),
                            CreatedAt = new DateTime(2025, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc),
                            CreatorId = "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
            ...
            modelBuilder.Entity("GainBase.Data.Models.GymSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GainBase.Data.Models.GymSessionExerciseLog", b =>
                {
                    ...
                    b.HasKey("GymSessionId", "ExerciseId");

                    b.HasIndex("ExerciseId");

                    b.ToTable("GymSessionExerciseLogs");
                });
            ...
            modelBuilder.Entity("GainBase.Data.Models.Workout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GainBase.Data.Models.WorkoutExercise", b =>
                {
                    b.Property<Guid>("WorkoutId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GainBase.Data.Models.GymSession", b =>
                {
                    ...
                    b.HasOne("GainBase.Data.Models.Workout", "Workout")
            ...
            modelBuilder.Entity("GainBase.Data.Models.GymSessionExerciseLog", b =>
                {
                    b.HasOne("GainBase.Data.Models.Exercise", "Exercise")
                        .WithMany("GymSessionExerciseLogs")
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GainBase.Data.Models.GymSession", "GymSession")
            ...
            modelBuilder.Entity("GainBase.Data.Models.Exercise", b =>
                {
                    b.Navigation("GymSessionExerciseLogs");
